...
namespace AcousticsUtils
{
    ...
    template <typename T>
    static Triton::Vec3d ToTritonVectorDouble(const T& t)
    {
    ...
    template <typename T>
    static T TritonPositionToUnreal(const T& vec)
    {
    ...
    // scale (negate Y and convert from cm to c)
    template <typename T>
    static T UnrealPositionToTriton(const T& vec)
    {
    ...
    template <typename T>
    static T TritonValToUnreal(const T val)
    {
    ...
    template <typename T>
    static T UnrealValToTriton(const T val)
    {
    ...
    // including scale
    template <typename T>
    inline T TritonDirectionToHrtfEngine(const T& Input)
    {
    ...
    // including scale
    template <typename T>
    inline T HrtfEngineDirectionToTriton(const T& Input)
    {
        return {Input.X, -Input.Z, Input.Y};
    }
    ...
    // including scale
    template <typename T>
    inline T UnrealDirectionToHrtfEngine(const T& Input)
    {
        return {Input.X, Input.Z, Input.Y};
    }
    ...
    // including scale
    template <typename T>
    inline T HrtfEngineDirectionToUnreal(const T& Input)
    {
        return {Input.X, Input.Z, Input.Y};
    }
