...
FAcousticsSpatializer::FAcousticsSpatializer()
{
#if PLATFORM_WINDOWS
...
#else
    UE_LOG(LogProjectAcousticsSpatializer, Error, TEXT("Unsupported Platform. Supported platforms are WINDOWS and ANDROID"));
    return;
#endif
}
